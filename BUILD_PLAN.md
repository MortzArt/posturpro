...
- [x] **T20 — Storefront restyle: Factorial design language, Phase A homepage (owner approval gate)** (tier: standard; PlanResearch → UI Design → Dev → ReviewFix → QA PASS HIGH, 2026-08-27; owner review of homepage pending → Phase B (T21) only on explicit approval)
