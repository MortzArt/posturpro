...
| `b2b/quote-office.jpg` | B2B `/empresas` quote-form companion (`B2B_QUOTE_IMAGE`) | — owner-supplied photo (open-plan office: rows of black mesh task chairs, teal acoustic baffles with linear lights, exposed concrete ceiling), not stock | PosturPro (owner) | — | ~4/5 · 790×1000 · 276 KB (2026-09-12) |
