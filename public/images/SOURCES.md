...
| `b2b/meeting-room-chairs-portrait.jpg` | B2B `/empresas` hero (`B2B_HERO_IMAGE`) | — owner-supplied photo (grey leather executive chairs, chrome frames, white meeting table; full portrait original, the 4/3 frame crops via `object-cover`), not stock | PosturPro (owner) | — | 2/3 · 800×1200 · 276 KB (2026-09-12) |
