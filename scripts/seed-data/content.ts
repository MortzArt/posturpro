...
export const STATIC_PAGES: StaticPageSeed[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "",
      "## Dirección",
      "Av. Azcapotzalco 202, Col. Ángel Zimbrón, Azcapotzalco, 02099 Ciudad de México, CDMX. Showroom con cita previa.",
    ].join("\n"),
    en: {
      title: "Contact",
      body: [
        ...
        "",
        "## Address",
        "Av. Azcapotzalco 202, Col. Ángel Zimbrón, Azcapotzalco, 02099 Mexico City, CDMX. Showroom visits by appointment.",
      ].join("\n"),
    },
  },
  {
    ...
    body: [
      ...
      "",
      "## Dirección",
      "Av. Azcapotzalco 202, Col. Ángel Zimbrón, Azcapotzalco, 02099 Ciudad de México, CDMX.",
      "",
      "## Horario",
    ...
    en: {
      ...
      body: [
        ...
        "",
        "## Address",
        "Av. Azcapotzalco 202, Col. Ángel Zimbrón, Azcapotzalco, 02099 Mexico City, CDMX.",
        "",
        "## Hours",
