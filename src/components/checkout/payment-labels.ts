...
export function buildPaymentPanelLabels(t: Translator): PaymentPanelLabels {
  return {
    ...
    rateLimitedBody: t("payment.rateLimited.body"),
    rateLimitedRetry: t("payment.rateLimited.retry"),
    staleTitle: t("payment.stale.title"),
    staleBody: t("payment.stale.body"),
    staleReload: t("payment.stale.reload"),
