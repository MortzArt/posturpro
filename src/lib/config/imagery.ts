...
/**
 * B2B `/empresas` hero image (4/3, matches `HeroMedia`; the owner's own 4/3
 * crop, so nothing is lost to `object-cover`). Owner-supplied photo (2026-09-13):
 ...
 */
export const B2B_HERO_IMAGE: string | null = "/images/b2b/meeting-room-chairs-4x3.webp";
