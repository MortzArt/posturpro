...
const CONSUMED_KEYS: readonly string[] = [
  ...
  "toggle.esName",
  "toggle.enName",
  // footer (site-footer) — 3 link columns + Legal after T13 reconciliation
  "footer.freeShipping",
  ...
  "whatsapp.label",
  // home (homepage hero + featured, T13)
  "home.hero.title",
  "home.hero.subtitle",
  "home.hero.ctaCatalog",
  "home.hero.ctaBrands",
  "home.hero.imageAlt",
  "home.featured.productsHeading",
  "home.featured.brandsHeading",
  "home.featured.viewAllProducts",
  "home.featured.viewAllBrands",
  // contact (contact page + form, T13)
  ...
  "contact.errors.nameTooLong",
  "contact.errors.emailRequired",
  "contact.errors.emailInvalid",
  "contact.errors.emailTooLong",
  "contact.errors.subjectTooLong",
  "contact.errors.messageRequired",
  "contact.errors.messageTooLong",
  // showroom (showroom page, T13)
  "showroom.metadata.title",
  "showroom.viewOnMaps",
  "showroom.mapAlt",
  // notFound (not-found)
  "notFound.code",
