...
const CONSUMED_KEYS: readonly string[] = [
  ...
  "nav.items.business",
  "nav.items.trust",
  // topbar (site-topbar, T19)
  "topbar.msg1",
  "topbar.msg2",
  "topbar.msg3",
  "topbar.contactPrefix",
  "topbar.contactAria",
  // header (site-header CTA + nav aria, mobile-nav CTA, T19)
  "header.navAria",
  "header.cta",
  // product grade badge (product-grid, PDP, recently-viewed, T19)
  "product.grade.badge",
  ...
  "whatsapp.label",
  // home (homepage rebuild, T19) — hero + sections
  "home.hero.eyebrow",
  "home.hero.headlineL1",
  "home.hero.headlineL2",
  "home.hero.subtitle",
  "home.hero.ctaCatalog",
  "home.hero.ctaBusiness",
  "home.hero.imageAlt",
  "home.hero.stats.s1Figure",
  "home.hero.stats.s1Label",
  ...
  "home.ctaBanner.cta1",
  "home.ctaBanner.cta2",
  // home footer (site-footer, T19)
  "home.footer.blurb",
  "home.footer.colCatalogHeading",
  "home.footer.linkAllChairs",
  "home.footer.colContactHeading",
  "home.footer.contactWhatsapp",
  "home.footer.copyright",
  "home.footer.payments",
  "home.footer.legalPrivacy",
  "home.footer.socialInstagram",
  ...
  "showroom.viewOnMaps",
  "showroom.mapAlt",
  // empresas (B2B landing page + quote form, T16)
  "empresas.metadata.title",
  "empresas.metadata.description",
  "empresas.hero.title",
  "empresas.hero.subtitle",
  "empresas.hero.cta",
  "empresas.hero.secondary",
  "empresas.hero.imageAlt",
  "empresas.value.heading",
  "empresas.value.pillars.ergonomics.title",
  "empresas.value.pillars.ergonomics.body",
  "empresas.value.pillars.brands.title",
  "empresas.value.pillars.brands.body",
  "empresas.value.pillars.value.title",
  "empresas.value.pillars.value.body",
  "empresas.process.heading",
  "empresas.process.steps.request.title",
  "empresas.process.steps.request.body",
  "empresas.process.steps.reply.title",
  "empresas.process.steps.reply.body",
  "empresas.process.steps.quote.title",
  "empresas.process.steps.quote.body",
  ...
  "empresas.form.name.label",
  "empresas.form.name.placeholder",
  "empresas.form.email.label",
  "empresas.form.email.placeholder",
  "empresas.form.phone.label",
  "empresas.form.phone.optional",
  "empresas.form.phone.placeholder",
  "empresas.form.teamSize.label",
  "empresas.form.teamSize.placeholder",
  "empresas.form.teamSize.options.1-10",
  "empresas.form.teamSize.options.11-50",
  "empresas.form.teamSize.options.51-200",
  "empresas.form.teamSize.options.200+",
  "empresas.form.needs.label",
  "empresas.form.needs.placeholder",
  "empresas.form.charCount",
  "empresas.form.submit",
  "empresas.form.submitting",
  "empresas.form.retry",
  "empresas.form.honeypot",
  "empresas.form.success",
  "empresas.form.errorGeneric",
  "empresas.form.rateLimited",
  "empresas.form.errors.companyRequired",
  "empresas.form.errors.companyTooLong",
  "empresas.form.errors.nameRequired",
  "empresas.form.errors.nameTooLong",
  "empresas.form.errors.emailRequired",
  "empresas.form.errors.emailInvalid",
  "empresas.form.errors.emailTooLong",
  "empresas.form.errors.phoneTooLong",
  "empresas.form.errors.teamSizeRequired",
  "empresas.form.errors.teamSizeInvalid",
  "empresas.form.errors.needsRequired",
  "empresas.form.errors.needsTooLong",
  // notFound (not-found)
  "notFound.code",
  "notFound.title",
